    ...
    return (
        <section className="bg-primary-50">
            <UserSectionWrapper className="items-center relative">
                <h2 className="font-oswald text-primary-500">Our Blogs</h2>

                <h4 className="hidden lg:block font-medium">
                    Helpful tips and guides about crypto wallets and gift cards
                </h4>
                <h5 className="lg:hidden font-medium">
                    Helpful tips and guides about crypto wallets and gift cards
                </h5>
